...
'description' => 'string',
'priority' => 'string',
'status' => '\Planfix\Model\TaskStatus',
'processId' => 'int',
'resultChecking' => 'bool',
'type' => 'string',
'assigner' => '\Planfix\Model\PersonResponse',
...
'dateOfLastUpdate' => '\Planfix\Model\TimePoint',
'duration' => 'int',
'durationUnit' => 'string',
'durationType' => 'string',
'overdue' => 'bool',
...
'recurrence' => '\Planfix\Model\Recurrence',
'isDeleted' => 'bool',
...
self::DURATION_TYPE_WORKER_DAYS,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['hasStartDate'] = isset($data['hasStartDate']) ? $data['hasStartDate'] : null;
        ...
        $this->container['dateOfLastUpdate'] = isset($data['dateOfLastUpdate']) ? $data['dateOfLastUpdate'] : null;
     ...
     * Gets status
     *
     * @return \Planfix\Model\TaskStatus
     */
     ...
     * Sets status
     *
     * @param \Planfix\Model\TaskStatus $status status
     *
     * @return $this
     */
     ...
     * Sets assigner
     *
     * @param \Planfix\Model\PersonResponse $assigner assigner
     *
     * @return $this
     */
    ...
    {
        return $this->container['hasStartDate'];
    }

    /**
     * Sets hasStartDate
     *
     * @param bool $hasStartDate hasStartDate
     *
     * @return $this
     */
    public function setHasStartDate($hasStartDate)
    {
        $this->container['hasStartDate'] = $hasStartDate;
     ...
     * Sets hasStartTime
     *
     * @param bool $hasStartTime hasStartTime
     *
     * @return $this
     */
     ...
     * Sets hasEndTime
     *
     * @param bool $hasEndTime hasEndTime
     *
     * @return $this
     */
    ...
    /**
     * Gets dateOfLastUpdate
     *
     * @return \Planfix\Model\TimePoint
     */
    public function getDateOfLastUpdate()
    {
        return $this->container['dateOfLastUpdate'];
    }

    /**
     * Sets dateOfLastUpdate
     *
     * @param \Planfix\Model\TimePoint $dateOfLastUpdate dateOfLastUpdate
     *
     * @return $this
     */
    public function setDateOfLastUpdate($dateOfLastUpdate)
    {
        $this->container['dateOfLastUpdate'] = $dateOfLastUpdate;
     ...
     * Gets recurrence
     *
     * @return \Planfix\Model\Recurrence
     */
     ...
     * Sets recurrence
     *
     * @param \Planfix\Model\Recurrence $recurrence recurrence
     *
     * @return $this
     */
